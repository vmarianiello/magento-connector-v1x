...
namespace Digitalriver\DrPay\Model\WireTransfer;
...
class ConfigProvider implements ConfigProviderInterface
{
     ...
     * @var string[]
     */
    protected $_methodCode = self::PAYMENT_METHOD_WIRE_TRANSFER_CODE;
    ...
    { 
        ...
        $country_check = true;
        $allowed_country_arr = "";
        $allowed_currency_path = 'payment/drpay_wire_transfer/allow_currency';  
        ...
        $allow_specific_country_path = 'payment/drpay_wire_transfer/allowspecific'; 
        ...
        if($allow_specific_country == 1) { 
            $allowed_country_path = 'payment/drpay_wire_transfer/specificcountry'; 
