...
namespace Digitalriver\DrPay\Model\IBP;
...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    const PAYMENT_METHOD_IBP_CODE = 'drpay_IBP';
    /**
     * @var string[]
     */
    protected $_methodCode = self::PAYMENT_METHOD_IBP_CODE;
    ...
    public function getConfig()
    {
        ...
        $country_check = true;
        $allowed_country_arr = "";
        $allowed_currency_path = 'payment/drpay_IBP/allow_currency';
        ...
        $allow_specific_country_path = 'payment/drpay_IBP/allowspecific';
        ...
        if ($allow_specific_country == 1) {
            $allowed_country_path = 'payment/drpay_IBP/specificcountry';
